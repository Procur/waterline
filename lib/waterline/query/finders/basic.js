  ...
  findOne: function(criteria, cb) {
    ...
    operations.run(function(err, values) {
      ...
      function returnResults(results) {
        ...
        // PROCUR PARANOID DELETION
        // This hook prevents findOne from returning model instances that have been deactivated,
        // i.e. the instance has its `deletedAt` field set.
        if (sails.config.procur.paranoid) {
          if (models[0].deletedAt) { models[0] = null; }
        }
